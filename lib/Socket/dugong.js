            ...
            interactiveMessage: {
                ...
                header: {
                    ...
                    productMessage: {
                        ...
                        businessOwnerJid: WABinary_1.jidNormalizedUser(this.sock.authState.creds.me.id)
                    }
                },
        ...
        if (image) {
            ...
            headerContent = {
                productMessage: {
                    ...
                    businessOwnerJid: businessOwnerJid || WABinary_1.jidNormalizedUser(this.sock.authState.creds.me.id)
                }
            };
            mediaAttached = typeof hasMediaAttachment === 'boolean' ? hasMediaAttachment : true;
        }
